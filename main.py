...
class Account:
    ...
    def __init__(self, account_no, first_name, last_name, offset= 7, balance=0):
        ...
        self.Transaction_code = 'T'

    def confirmation_no(self):
        result = Transaction(self.account_no,self.Transaction_code, self.tz_offset)
        return str(result)
    ...
    def deposit(self, amount):
        ...
        self.Transaction_code = 'D'

    def withdraw(self, amount):
        if amount > self.balance:
            print("transaction declined...")
            self.Transaction_code = 'X'
        else:
            print(f"{amount} debited...")
            self._balance -= amount
            self.Transaction_code = 'W'

    def int_calc(self):
        interest = self._balance * Account.interest
        self.Transaction_code = 'I'
...
hello = Account(11221234, "ajay", "lodhi", 7, 250)
print(hello.confirmation_no())
print(hello.deposit(500))
print(hello.confirmation_no())
hello.withdraw(250)
hello.withdraw(250)
print(hello.balance)
